...
The standardized request and response shapes are documented in [`server-interfaces.md`](../architecture/server-interfaces.md).
...
- [DTO Philosophy](dto-philosophy.md) - the one-shape rule for data transfer objects
- [Architectural Philosophy](../architecture/architectural-philosophy.md) - the high-level rules and directory layout
- [Server Interfaces](../architecture/server-interfaces.md) - how Express and Lambda adapters share the same controllers
