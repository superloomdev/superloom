...
All tests use Node.js's built-in test runner (`node --test`) and `node:assert/strict` - no external test framework. See [`architecture/testing-strategy.md`](../architecture/testing-strategy.md) and [`architecture/unit-test-authoring.md`](../architecture/unit-test-authoring.md) for the conventions.
...
| Goal | Read |
|---|---|
| Add your first domain entity | [Creating Entities](./creating-entities.md) |
...
| Read the full entity walkthrough | [Entity Creation Guide](../architecture/entity-creation-guide.md) |
