...
- [`module-categorization.md`](./module-categorization.md) — Class G (feature modules with extensions) and Class H (extension modules) definitions
- [`module-readme-structure.md`](./module-readme-structure.md) — README templates including extension modules
- [`complex-module-docs-guide.md`](./complex-module-docs-guide.md) — Parent vs extension documentation boundaries
