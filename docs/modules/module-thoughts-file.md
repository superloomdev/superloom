...
- [`module-structure-js.md`](module-structure-js.md) - Standard Files Per Module table which lists `THOUGHTS.md` alongside all other module files.
- [`module-publishing.md`](module-publishing.md) - `.npmignore` and equivalent registry exclusion rules.
- [`module-readme-structure.md`](module-readme-structure.md) - what goes in `README.md` and `docs/`; clarifies the boundary with `THOUGHTS.md`.
...
The canonical `.npmignore` reference implementation is `js-helper-utils`. Copy it as the starting point for any new module. See [module-publishing.md: Registry Ignore File](module-publishing.md#registry-ignore-file-npmignore) for the full `.npmignore` rules.
