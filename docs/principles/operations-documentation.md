...
- [Architectural Philosophy](../languages/js/project-structure.md) - the broader directory layout
- [Module Testing](../languages/js/module-testing.md) - how `_test/ops/` slots into the testing strategy
