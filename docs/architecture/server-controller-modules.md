...
Both the request and response shapes are documented in [`server-interfaces.md`](server-interfaces.md).
...
- [Server Interfaces](server-interfaces.md) - the standardized request and response formats
...
- [Error Handling](error-handling.md) - how the controller forwards domain errors via `Lib.Functions.errorResponse`
