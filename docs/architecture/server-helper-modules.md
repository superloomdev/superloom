...
See [`module-structure.md`](module-structure.md) for full templates and the rules each pattern follows.
...
- [Module Structure](module-structure.md) - the Pattern 2 (Factory) template every server helper follows
