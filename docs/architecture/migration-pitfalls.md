...
See [`module-structure.md`](module-structure.md#helper-module-pattern-factory) for the canonical structure.
...
- Use the [reference implementations](module-structure.md#reference-implementations) as a template
