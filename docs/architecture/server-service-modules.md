...
| **Translate helper-module errors into domain errors** | Mandatory - see [Error Handling](error-handling.md) |
...
- [Error Handling](error-handling.md) - the mandatory translation rule (helper envelope -> domain error)
