...
The full `index.js` template lives in [`module-structure.md`](module-structure.md#model-package-index).
...
Keys not provided (`undefined`) are simply **not added** to the resulting object. See [DTO Philosophy](../philosophy/dto-philosophy.md) for the rationale.
...
- [DTO Philosophy](../philosophy/dto-philosophy.md) - the one-shape rule for data transfer objects
- [Validation Approach](validation-approach.md) - how `[entity].validation.js` produces user-facing errors
- [Module Structure](module-structure.md#model-package-index) - the index file template and the merge pattern in detail
- [Server Loader](server-loader.md) - where the merge actually happens at runtime
- [Entity Creation Guide](entity-creation-guide.md) - end-to-end walkthrough for adding a new entity
