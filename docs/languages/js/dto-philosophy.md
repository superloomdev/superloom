...
> **Language:** [JavaScript](dto-philosophy.md)
...
- [Server Architecture](../../principles/server-architecture.md) - how DTOs fit into the layered architecture
- [Model Modules](server/model-modules.md) - the file layout for `[entity].data.js`
- [Validation Approach](validation.md) - how validation runs against DTO inputs
- [Entity Creation Guide](server/entity-creation-guide-js) - end-to-end example of building DTOs for a new entity
