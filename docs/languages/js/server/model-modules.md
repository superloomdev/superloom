...
The full `index.js` template lives in [`module-structure.md`](../module-structure#model-package-index).
...
Keys not provided (`undefined`) are simply **not added** to the resulting object. See [DTO Philosophy (JavaScript)](../dto-philosophy.md) for the rationale.
...
- [DTO Philosophy (JavaScript)](../dto-philosophy.md) - the one-shape rule for data transfer objects
- [Validation Approach](../validation.md) - how `[entity].validation.js` produces user-facing errors
- [Module Structure (JavaScript)](../module-structure#model-package-index) - the index file template and the merge pattern in detail
