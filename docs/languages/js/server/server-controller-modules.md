...
- [Validation Approach](../validation.md) - how validation runs inside the controller
- [Error Handling](../error-handling) - how the controller forwards domain errors via `Lib.Functions.errorResponse`
