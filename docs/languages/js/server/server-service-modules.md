...
| **Translate helper-module errors into domain errors** | Mandatory - see [Error Handling](../error-handling) |
...
- [Error Handling](../error-handling) - the mandatory translation rule (helper envelope -> domain error)
