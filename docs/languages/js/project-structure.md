...
Four rules govern every line of code in the project. Full detail in [`code-formatting.md`](code-formatting.md).
...
Module file structure and the configuration patterns for each helper type live in [`module-structure.md`](module-structure).
...
| `migration-changelog.md` | Personal log of module migrations (see [`pitfalls-migration.md`](pitfalls-migration.md)) |
...
| Topic | Document |
|---|---|
| **Coding standards** (formatting, naming, JSDoc) | [`code-formatting.md`](code-formatting.md) _(JavaScript)_ |
| **Module structure** (loader pattern, factory pattern) | [`module-structure.md`](module-structure) |
