...
All other modules may depend on the foundation modules via peer dependencies. This avoids duplicate installations and ensures a single shared instance. The full strategy is in [`dependencies.md`](dependencies.md).
...
- [Module README Structure](module-docs.md) - badges, Universal README Sections, and the structural-pass checklist.
