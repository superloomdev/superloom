...
Full publishing pipeline: [`publishing.md`](publishing.md). Peer dependency strategy: [`dependencies.md`](dependencies.md).
...
Full module structure templates (Pattern 1 Singleton vs Pattern 2 Factory) live in [`module-structure.md`](module-structure) under "Helper Module Configuration Patterns".
