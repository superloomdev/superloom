...
- [`unit-test-authoring.md`](unit-test-authoring.md) - how to actually write a single unit test (rules, naming, assertion methods, template).
- [`integration-testing.md`](integration-testing.md) - integration testing against real cloud services (sandbox accounts).
- [`pitfalls-migration.md`](pitfalls-migration.md) - testing issues encountered while migrating modules.
