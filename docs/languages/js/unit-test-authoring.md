...
> **Language:** [JavaScript](unit-test-authoring.md)
...
- [Mandatory Rules](#mandatory-rules)
  - [1. One `describe` block per exported function](#_1-one-describe-block-per-exported-function)
  - [2. Test naming convention](#_2-test-naming-convention)
  - [3. One assertion per test where possible](#_3-one-assertion-per-test-where-possible)
  - [4. Group by category with numbered section headers](#_4-group-by-category-with-numbered-section-headers)
  - [5. Test every exported function](#_5-test-every-exported-function)
  - [6. Include edge cases from the source code](#_6-include-edge-cases-from-the-source-code)
  - [7. Use `strictEqual` for primitives, `deepStrictEqual` for objects](#_7-use-strictequal-for-primitives-deepstrictequal-for-objects)
  - [8. No console.log in tests](#_8-no-console-log-in-tests)
  - [9. Test inputs and expected outputs must be explicit](#_9-test-inputs-and-expected-outputs-must-be-explicit)
  - [10. No mutation side effects between tests](#_10-no-mutation-side-effects-between-tests)
- [How to Write Tests for a New Module (Step by Step)](#how-to-write-tests-for-a-new-module-step-by-step)
...
- [Test Double Patterns: memory-store vs stub-adapter vs engine-stub vs emitter-stub](#test-double-patterns-memory-store-vs-stub-adapter-vs-engine-stub-vs-emitter-stub)
  - [Pattern 1: `memory-store` (a Fake)](#pattern-1-memory-store-a-fake)
  - [Pattern 2: `stub-adapter` (a Stub)](#pattern-2-stub-adapter-a-stub)
  - [Decision Table](#decision-table)
  - [Using Several in the Same Module](#using-several-in-the-same-module)
  - [ESM Interop in Test Loaders](#esm-interop-in-test-loaders)
  - [Pattern 3: `engine-stub` (an Engine Fake)](#pattern-3-engine-stub-an-engine-fake)
  - [Pattern 4: `emitter-stub` (a Subscribable Fake)](#pattern-4-emitter-stub-a-subscribable-fake)
- [Config Absorption Contract](#config-absorption-contract)
  - [Why this matters](#why-this-matters)
  - [The four promises](#the-four-promises)
  - [The core challenge: CONFIG is private](#the-core-challenge-config-is-private)
  - [Decision tree](#decision-tree)
  - [What to assert (keep it to 3–5 `it` blocks)](#what-to-assert-keep-it-to-3–5-it-blocks)
  - [Finding the null-meaningful key](#finding-the-null-meaningful-key)
  - [`validBaseConfig()` helper](#validbaseconfig-helper)
  - [Template 1 - Validation-throw (Archetype A)](#template-1-validation-throw-archetype-a)
  - [Template 2 - Behavioral (Archetype B)](#template-2-behavioral-archetype-b)
