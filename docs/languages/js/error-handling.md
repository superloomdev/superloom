...
See [`validation.md`](validation.md) for the validation patterns themselves.
...
- The `message` field of domain errors in `[entity].errors.js` - that is user-facing copy and follows the [validation approach](validation.md).
...
- [Validation Approach](validation.md) - how `[entity].validation.js` produces the user-facing errors
