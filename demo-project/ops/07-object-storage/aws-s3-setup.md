...
> Reference: docs/ops/object-storage/aws-s3-setup.md
...
- Each bucket is accessible with the appropriate IAM user credentials
- Public buckets serve static content via their website endpoint
- CORS configuration allows requests from expected origins
- Lifecycle rules auto-expire temporary uploads
