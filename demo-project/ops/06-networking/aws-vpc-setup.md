...
> Reference: docs/ops/networking/aws-vpc-setup.md
...
- Lambda functions can access required services (databases, S3, external APIs)
- If using VPC: subnets have sufficient IP addresses
