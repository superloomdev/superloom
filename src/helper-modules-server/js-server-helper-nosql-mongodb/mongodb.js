    ...
    *********************************************************************/
    getRecord: async function (instance, collection, filter, options) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB getRecord failed', { collection: collection, error: error.message });
    ...
    *********************************************************************/
    writeRecord: async function (instance, collection, filter, document) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB writeRecord failed', { collection: collection, error: error.message });
    ...
    *********************************************************************/
    deleteRecord: async function (instance, collection, filter) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB deleteRecord failed', { collection: collection, error: error.message });
    ...
    *********************************************************************/
    updateRecord: async function (instance, collection, filter, update) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB updateRecord failed', { collection: collection, error: error.message });
    ...
    *********************************************************************/
    query: async function (instance, collection, filter, options) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB query failed', { collection: collection, error: error.message });
    ...
    *********************************************************************/
    count: async function (instance, collection, filter) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB count failed', { collection: collection, error: error.message });
    ...
    *********************************************************************/
    scan: async function (instance, collection, filter, options) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB scan failed', { collection: collection, error: error.message });
    ...
    *********************************************************************/
    deleteRecordsByFilter: async function (instance, collection, filter) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB deleteRecordsByFilter failed', { collection: collection, error: error.message });
    ...
    *********************************************************************/
    batchGetRecords: async function (instance, idsByCollection) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB batchGetRecords failed', { error: error.message });

        // Return error response
        return {
          success: false,
          documents: {},
          error: { type: 'BATCH_GET_ERROR', message: error.message }
        };
    ...
    *********************************************************************/
    batchWriteAndDeleteRecords: async function (instance, operationsByCollection) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB batchWriteAndDeleteRecords failed', { error: error.message });

        // Return error response
        return {
          success: false,
          results: {},
          error: { type: 'BATCH_WRITE_DELETE_ERROR', message: error.message }
        };
    ...
    *********************************************************************/
    batchWriteRecords: async function (instance, documentsByCollection) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB batchWriteRecords failed', { error: error.message });

        // Return error response
        return {
          success: false,
          results: {},
          error: { type: 'BATCH_WRITE_ERROR', message: error.message }
        };
    ...
    *********************************************************************/
    batchDeleteRecords: async function (instance, idsByCollection) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB batchDeleteRecords failed', { error: error.message });
    ...
    *********************************************************************/
    transactWriteRecords: async function (instance, callback) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB transactWriteRecords failed', { error: error.message });

        // Return error response
        return {
          success: false,
          result: null,
          error: { type: 'TRANSACTION_ERROR', message: error.message }
        };
    ...
    *********************************************************************/
    close: async function (_instance) {
      ...
      try {
        ...
        Lib.Debug.debug('MongoDB close failed', { error: error.message });
