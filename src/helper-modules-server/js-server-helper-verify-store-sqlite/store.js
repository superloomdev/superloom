// Info: SQLite store adapter for js-server-helper-verify. Fully self-contained -
// every DDL statement, UPSERT template, CRUD query, and identifier-quoting
// rule in this file is specific to SQLite.
//
