...
// (adapter unit tests, no logger.js dependency) and Tier 3 (full logger
// lifecycle via the store contract suite) can share the same runtime objects.
//
...
module.exports = function loader () {
  ...
  Lib.MongoDB = require('@superloomdev/js-server-helper-nosql-mongodb')(Lib, config_mongodb);
